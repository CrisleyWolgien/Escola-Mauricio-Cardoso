...
const emptyForm = { title: "", summary: "", content: "", category: "Geral", cover_image_url: "", status: "draft" };
...
export default function AdminAnnouncements() {
  ...
  useEffect(() => { load(); }, []);
  function edit(item) { setEditingId(item.id); setForm({ ...item, summary: item.summary || item.content, cover_image_url: item.cover_image_url || "" }); window.scrollTo({ top: 0, behavior: "smooth" }); }
